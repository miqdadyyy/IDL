...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <li class="treeview {{ request()->is('admin/post*') ? 'is-expanded' : '' }}"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Post Management</span><i class="treeview-indicator fa fa-angle-right"></i></a>
