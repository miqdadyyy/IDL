...
<section class="isi wow fadeInUp" style="">
  <div class="container">
    <img class="wow fadeIn" src="img/logo_laosarena.png" alt="Laos Arena" id="img-limit">
    <h1>Laos Arena</h1>
...
<hr>
<section class="page-timeline wow fadeInUp" id="timeline" style="background-color:#FCFCFC;padding:50px;">
  <div class="container">
