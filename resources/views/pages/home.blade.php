...
@section('content')
  ...
  <section class="event-desc" style="background-color:#66ff99;padding:2% 0 2% 0">
    <div class="container">
      <div class="row">
      ...
      <div class="col-sm-12 text-center">
        <ul class="list-inline social">
          <li class="wow slideInLeft" data-wow-delay="0.3s">
            <img src="img/logo_isic.png" alt="ISIC" id="lomba">
            <h4>ISIC</h4>
            <a class="btn-dark" href="#">Selengkapnya</a><br>
            <a class="btn-light" href="#">Download Guidebook</a>
          </li>
          <li class="wow slideInLeft" >
            <img src="img/logo_itec.png" alt="ITeC" id="lomba">
            <h4>ITeC</h4>
            <a class="btn-dark" href="#">Selengkapnya</a><br>
            <a class="btn-light" href="#">Download Guidebook</a>
          </li>
          <li class="wow slideInRight" >
            <img src="img/logo_laosarena.png" alt="Laos Arena" id="lomba">
            <h4>Laos Arena</h4>
            <a class="btn-dark" href="#">Selengkapnya</a><br>
            <a class="btn-light" href="#">Download Guidebook</a>
          </li>
          <li class="wow slideInRight" data-wow-delay="0.3s">
            <img src="img/logo_pkmgo.png" alt="PKM-GO" id="lomba">
            <h4>PKM GO</h4>
            <a class="btn-dark" href="#">Selengkapnya</a><br>
            <a class="btn-light" href="#">Download Guidebook</a>
          </li>
...
<section class="home-timeline" id="timeline" style="background-color:#FCFCFC;">
  <div class="container">
    <div class="row">
      <div class="col-sm-8 margin">
        <h3 class="head-section wow fadeIn" id="white">Timeline</h3>
        <div class="wow slideInLeft" style="margin-bottom: 20px;">
          <p id="white">Persiapkan dirimu untuk berpartisipasi dalam rangkaian acara IDLe 2019</p>
          <ul >
